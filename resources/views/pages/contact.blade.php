            ...
            <div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">colegiomisprimerosamiguitos@gmail.com</p>
                        </div>
                    </div>
                ...
                <div class="mt-10">
                    ...
                    <div class="flex space-x-3">
                        <a href="https://www.facebook.com/jacqueline.pechecodevega" class="w-12 h-12 bg-blue-600 hover:bg-blue-700 rounded-xl flex items-center justify-center text-white transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/colegiomisprimerosamiguitos/" class="w-12 h-12 bg-pink-600 hover:bg-pink-700 rounded-xl flex items-center justify-center text-white transition-colors">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="https://www.tiktok.com/@colmipram.cesar" class="w-12 h-12 bg-green-600 hover:bg-green-700 rounded-xl flex items-center justify-center text-white transition-colors">
...
<section class="h-96 bg-gray-300">
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1964.7826973233643!2d-73.88717455948071!3d9.970069994532844!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e5f9375be82902d%3A0x305eae445e9dae18!2sCra.%2021%20%231546%2C%20Bosconia%2C%20Cesar!5e0!3m2!1ses!2sco!4v1766495742882!5m2!1ses!2sco"
